                ...
                <div className="container flex justify-between items-center">
                            ...
                            <ul className="flex justify-between items-center gap-4">
                                {
                                    MenuLinks.map((data, index) => (
                                        <li key={index}>
                                            <a
                                                href={data.link}
                                                className="inline-block px-4 font-semibold text-gray-500 hover:text-black dark:hover:text-white duration-200">{data.name}
                                            </a>
                                        </li>
                                    ))
                                }
                    ...
                    <div className="flex justify-between items-center gap-4">
                        ...
                        <button className="relative p-3">
                            ...
                            <div className="h-4 w-4 bg-red-500 text-white rounded-full absolute top-0 right-0 flex justify-center items-center text-xs ">4</div>
                        </button>
